...
# As an example GoogleSearch("Cristiano Ronaldo")
...
# As an example Content("Write a application for clean water to municipality")
...
# As an example PlayYoutube("On Top by Karan Aujla")
...
if __name__=="__main__":
    asyncio.run(Automation(["content rap song on global warming "]))
