...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("background-color: #000000;")  # Using hex code for black
        ...
        self.label = QLabel("")
        self.label.setStyleSheet("color: #FFFFFF; font-size: 16px; margin-right: 195px; border: none; margin-top: -30px;")  # Using hex code for white
    ...
    def load_icon(self, path, width=60, height=60):
        ...
        self.icon_label_setPixmap(new_pixmap)
